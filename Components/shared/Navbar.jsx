            ...
            `}
                ...
                >
                  {navItems.map(({ name, path }) =>
                    name === "About" ? (
                      <li
                        key={path}
                        className="flex items-center gap-2 py-4 transition-colorsx duration-300 hover:text-red-500 focus:text-emerald-600 focus:outline-none focus-visible:outline-none lg:px-8 cursor-pointer"
                      >
                        <Link href="/elements/about-us">{name}</Link>
                      </li>
                    ) : (
                      <ScrollLink
                  ...
                  <li role="none" className="flex items-stretch">
                    <Link
                      role="menuitem"
                      aria-haspopup="false"
                      className="flex items-center gap-2 py-4 transition-colorsx duration-300 hover:text-red-500 focus:outline-none focus-visible:outline-none lg:px-8"
                      href="/blog"
                    >
                      <span>Blog</span>
                    </Link>
                ...
                <li role="none" className="flex items-stretch">
                  <a
                    ...
                    aria-current="page"
                    aria-haspopup="false"
                    className="flex items-center gap-2 py-4 text-emerald-500 transition-colorsx duration-300 hover:text-emerald-600 focus:text-emerald-600 focus:outline-none focus-visible:outline-none lg:px-8"
                    href="javascript:void(0)"
                  >
                    <span>Pricing</span>
                  </a>
                ...
                <li role="none" className="flex items-stretch">
                  <a
                    role="menuitem"
                    aria-haspopup="false"
                    className="flex items-center gap-2 py-4 transition-colorsx duration-300 hover:text-emerald-500 focus:text-emerald-600 focus:outline-none focus-visible:outline-none lg:px-8"
                    href="javascript:void(0)"
                  >
                    <span>About</span>
                  </a>
