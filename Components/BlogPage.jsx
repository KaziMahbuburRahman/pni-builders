    ...
    return (
        <div className="w-full h-full bg-white dark:bg-gray-800">
            <div className="w-full mx-auto py-10 bg-white dark:bg-gray-800">
                ...
                >
                    <div className="flex items-center justify-between w-full lg:w-[80%] md:w-[90%] sm:w-[96%]">
                        {/* Blog Image */}
                        ...
                        <div className="content flex flex-col">
                            <span className="text-sm font-bold">
                                <Link href="/category/trickbd-notice">Trickbd Notice</Link>
                            </span>
                            ...
                            <div className="w-[90%] mx-auto flex md:flex-row xs:flex-col gap-4 items-center justify-center pt-4">
