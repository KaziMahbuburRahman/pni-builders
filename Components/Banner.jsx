      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col justify-center items-center px-4 py-36 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 md:py-16 text-white">
          <h1 className="text-3xl font-bold md:flex flex-col justify-center items-center lg:text-6xl tracking-normal md:leading-[1.4em] lg:leading-[1.2em] capitalize">
            ...
            <span className="font-medium bg-clip-text text-transparent bg-gradient-to-tr from-[#c01d2e] via-yellow-300 to-slate-500">
              Service
            </span>{" "}
          </h1>
          <div className="">
            ...
            <a
              href="#contact"
              className="flex justify-center w-6/12 mx-auto bg-gradient-to-tr from-[#c01d2e] to-yellow-300 font-bold tracking-wide text-white capitalize transition-all duration-300 py-4 px-10 lg:px-8 xl:px-10 hover:bg-gradient-to-tr hover:from-white hover:text-black hover:to-stone-600 hover:shadow-md rounded-md"
            >
