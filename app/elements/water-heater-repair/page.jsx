...
const services = [
    ...
    "Leakage from Plumbing Connections"
  ];
      ...
      <motion.section className="py-12 md:py-24 lg:mx-36" initial="hidden" 
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <h3 className="text-3xl font-bold mb-4">The Best Water Heater Repair & Replacement Services</h3>
            <p className="mb-4">Looking for waterheater repair services near you? Our professional expert team will water heater repair & replacement services. Our best service in timely manner in singapore all area. Century Handyman Service has trusted & experienced about water heater repair & replacement services in singapore.</p>
          ...
          <div className="md:w-1/2">
            <motion.img
              src="https://www.centuryhandymanservice.com/wp-content/uploads/2024/04/5a173143f4308f0001d51cae_hot-water-tank.jpeg"
     ...
     <div className="w-full bg-gray-100">
        <motion.section className="py-12 lg:px-36" variants={stagger}>
          <div className="text-center mb-12">
            ...
            <p className="max-w-2xl mx-auto">Get professional water heater repair & replacement service in singapore. Fast, Same Day water heater repair & replacement service. We are waiting to your call to help you with any issue regarding of water heater repair & replacement service. We believe honesty and respect are two pillars for customer relationship.</p>
          </div>
