      ...
      <motion.section className="py-12 md:py-24 lg:mx-36" initial="hidden" 
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <h3 className="text-3xl font-bold mb-4">Best Plumbing & Sanitary Services</h3>
            <p className="mb-4">Looking for electric & plumbing services near you? Our professional expart team will fix your plumbing & Sanitary problem. Our best service in timely manner in singapore all area. Century Handyman Service has trusted & experienced electrician and plumber in singapore.</p>
