...
const services = [
    ...
    "Ceramic Tile & Grout Cleaning Services",
    "Wooden Flooring",
    "Vinyl Flooring",
    "Marble Flooring",
    "Kitchen Countertop",
    "Toilet Marble Flooring",
    ...
    <motion.div className="container mx-auto px-4" initial="initial" animate="animate">
      <motion.section className="py-12 md:py-24 lg:mx-36" initial="hidden" 
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <h3 className="text-3xl font-bold mb-4">The Best Polishing Service</h3>
            <p className="mb-4">Looking for polishing service near you? Our professional expert team will fix your polishing service solution. Our best service in timely manner in singapore all area. Century Handyman Service has trusted & experienced about polishing service in singapore.</p>
      ...
      <motion.section className="py-12 bg-gray-100 lg:px-36" variants={stagger}>
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto">Get professional polishing service in singapore. Fast, Same Day polishing service. We are waiting to your call to help you with any issue regarding of polishing service. We believe honesty and respect are two pillars for customer relationship.
