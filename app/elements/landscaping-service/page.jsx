      ...
      <motion.section className="py-12 md:py-24 lg:mx-36" initial="hidden" 
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            The Best Landscaping Services</h3>
            <p className="mb-4">Looking for landscaping service near you? Our professional expert team will fix your landscaping problem. Our best service in timely manner in singapore all area. Century Handyman Service has trusted & experienced about landscaping service in singapore.</p>
          ...
          <div className="md:w-1/2">
            <motion.img
              src="https://www.centuryhandymanservice.com/wp-content/uploads/2024/04/lawn-mowing-shutterstock-scaled-1-663x434-1.jpg"
