...
const services = [
    ...
    "Door Sanding and Varnishing",
    "Wall Painting Peeling Repair",
    "Gate Painting",
    "Door Frame Repair & Painting",
    "Handrail Painting",
    "Window Frame Painting",
    "Door Patch Up and Varnish",
    "Wall Plastering",
    "Ceiling Painting",
    "Ceiling Plastering",
    "Furniture Sanding and Varnishing",
    "Commercial Toilet Painting",
    "Corridor Painting",
    "Staircase Painting",
    "Furniture Painting",
    "Fix Wall Cracks",
    ...
    <motion.div className="container mx-auto px-4" initial="initial" animate="animate">
      <motion.section className="py-12 md:py-24 lg:mx-36" initial="hidden" 
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <h3 className="text-3xl font-bold mb-4">The Best Painting Service</h3>
            <p className="mb-4">Looking for Painting Service near you? Our professional expert team will Painting your home or commercial industry. Our best service in timely manner in singapore all area. Century Handyman Service has trusted & experienced about painting service in singapore.</p>
      ...
      <motion.section className="py-12 bg-gray-100 lg:px-36" variants={stagger}>
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto">Get professional Painting Service in singapore. Fast, Same Day Painting Service. We are waiting to your call to help you with any issue regarding of Painting Service. We believe honesty and respect are two pillars for customer relationship.</p>
        </div>
