...
function Index() {
    ...
    <div className="overflow-x-auto container editor mx-auto w-10/12 flex flex-col text-gray-800 max-w-4xl">
    <table className="min-w-[90%] shadow-md border mx-auto border-gray-100 m-5">
        <thead>
